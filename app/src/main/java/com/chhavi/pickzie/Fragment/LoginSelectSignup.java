 ...
 */
public class LoginSelectSignup extends Fragment implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {


    public LoginSelectSignup() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_login_select_signup, container, false);
        view.findViewById(R.id.login_signup_signup).setOnClickListener(this);
        view.findViewById(R.id.login_signup_facebook).setOnClickListener(this);
        view.findViewById(R.id.login_signup_google).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.login_signup_signup:
                ...
                break;
            case R.id.login_signup_facebook:
